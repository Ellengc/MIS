  ...
  $('#gname').combobox({    
	...
	$('#back-user').datagrid({    
	    ...
	    columns:[[    
	        ...
	        {field:'Mid',title:'所在门面',sortable:true,width:200,editor:{type:'text',options:{required:true,},},
	        formatter: function(value,row,index){
				if (row.menDian){
					return row.menDian.name;
				} else {
					return value;
				}
			},},     
	...
	<div id="tb">
		<div style="padding: 5px;">
			<!-- <a id="btn" href="#" class="easyui-linkbutton"
				...
				根据门店查询用户:
				<select class="easyui-textbox" id="mname" name="mname" data-options="iconCls:'icon-search'" style="width: 180px"
				prompt="请输入你要查询的email"></select>
